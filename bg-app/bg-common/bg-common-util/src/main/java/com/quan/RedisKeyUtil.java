...
public class RedisKeyUtil {
	 ...
	 */
	private static final String RESET_PWD_TOKEN_KEY = "bgcloud:restPwd";
	private static final String ACTIVE_USER = "bgcloud:activeUser";
	private static final String SEND_SMS_COUNT = "bgcloud:sms:count";
	private static final String SEND_EMAIL_CODE = "bgcloud:email:code";
	private static final String ACCESS_TOKEN = "bgcloud:token:accessToken";
	private static final String UPLOAD_FILE_SIZE = "bgcloud:file:upload_file_size";
