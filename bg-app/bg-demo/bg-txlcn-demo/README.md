...
工程目录：`bg-monitor-center\bg-transaction`，修改eureka、数据库和redis

### 2. 启动TxManager

工程目录：`bg-monitor-center\bg-transaction`

### 3. 初始化demo的数据

执行`bg-app\bg-demo\bg-txlcn-demo\txlcn-demo.sql`脚本

### 4. 修改3个服务的配置

修改`txlcn-demo-spring-service-a`、`txlcn-demo-spring-service-b`、`txlcn-demo-spring-service-c`的地址和数据库地址
