...
public class WxPay3Util {
    ...
    public static String createSign(String data, PrivateKey privateKey) throws Exception {
        ...
        return Base64.encodeToString(sign.sign(), false);
    }
    ...
    public static String encryptByPrivateKey(String data, PrivateKey privateKey) throws Exception {
        ...
        return Strings.sNull(java.util.Base64.getEncoder().encodeToString(signed));
    }
    ...
    public static String getCertSerialNo(String v3CertPath) {
        X509Certificate certificate = WxPay3Util.getCertificate(Files.findFileAsStream(v3CertPath));
     ...
     * @throws Exception
     */
    public static Map<String,Object> getJsapiSignMessage(String appId, String prepay_id, String keyPath) throws Exception {
    ...
    public static String verifyNotify(String serialNo, String body, String signature, String nonce,
        ...
        if (serialNumber.equals(serialNo)) {
            ...
            if (verifySignature) {
                Map resMap = JSON.parseObject(body,Map.class);
                Map resource = (Map) resMap.getOrDefault("resource", Map.class);
                String cipherText = Strings.sNull(resource.getOrDefault("ciphertext",""));
                String nonceStr = Strings.sNull(resource.getOrDefault("nonce",""));
                String associatedData = Strings.sNull(resource.getOrDefault("associated_data",""));
                // 密文解密
