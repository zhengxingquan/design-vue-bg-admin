...
public class WxApi2Impl extends AbstractWxApi2 {
    ...
    public WxResp qrcode_create(Object scene_id, int expire_seconds) {
        LinkedHashMap params = new LinkedHashMap(), scene = new LinkedHashMap();
        // 临时二维码
        if (expire_seconds > 0) {
     ...
     */
    @Override
    public WxResp card_create(Map<String, Object> card) {
     ...
     */
    @Override
    public WxResp card_qrcode_create(Map<String, Object> body) {
    ...
    public WxResp kfaccount_uploadheadimg(String kf_account, File f) {
        ...
        return JSON.parseObject((InputStream) resp.getReader("UTF-8"), WxResp.class);
    }
     ...
     */
    @Override
    public Map postPay(String url, String key, Map<String, Object> params) {
        params.remove("sign");
     ...
     */
    @Override
    public Map postPay(String url, String key, Map<String, Object> params, Object keydata, String password) {
        params.remove("sign");
        String sign = WxPaySign.createSign(key, params);
        params.put("sign", sign);
        Request req = Request.create(url, METHOD.POST);
     ...
     */
    @Override
    public Map pay_unifiedorder(String key, WxPayUnifiedOrder wxPayUnifiedOrder) {
     ...
     */
    @Override
    public Map pay_jsapi(String key, WxPayUnifiedOrder wxPayUnifiedOrder) {
        Map map = this.pay_unifiedorder(key, wxPayUnifiedOrder);
        Map params = Map.NEW();
     ...
     */
    @Override
    public Map pay_transfers(String key, WxPayTransfers wxPayTransfers, Object keydata, String password) {
     ...
     */
    @Override
    public Map send_redpack(String key, WxPayRedPack wxRedPack, Object keydata, String password) {
     ...
     */
    @Override
    public Map send_redpackgroup(String key, WxPayRedPackGroup wxRedPackGroup, Object keydata, String password) {
     ...
     */
    @Override
    public Map send_coupon(String key, WxPayCoupon wxPayCoupon, Object keydata, String password) {
     ...
     */
    @Override
    public Map pay_refund(String key, WxPayRefund wxPayRefund, Object keydata, String password) {
     ...
     */
    @Override
    public Map pay_refundquery(String key, WxPayRefundQuery wxPayRefundQuery) {
        String url = payBase + "/pay/refundquery";
        Map<String, Object> params = Langs.obj2map(wxPayRefundQuery);
        return this.postPay(url, key, params);
    }
    ...
    public WxResp menu_addconditional(List<WxMenu> button, WxMatchRule matchrule) {
        return postJson("/menu/addconditional", Map.NEW().addv("button", button).addv("matchrule", matchrule));
    }

    @Override
    public WxResp menu_delconditional(String menuid) {
        return postJson("/menu/delconditional", Map.NEW().addv("menuid", menuid));
    }

    @Override
    public WxResp menu_trymatch(String user_id) {
        return postJson("/menu/trymatch", Map.addv("user_id", user_id));
    }

    @Override
    public Map pay_transfers(String key, WxPayTransfers wxPayTransfers, File keydata, String password) {
        return pay_transfers(key, wxPayTransfers, (Object) keydata, password);
    }

    @Override
    public Map send_redpack(String key, WxPayRedPack wxRedPack, File keydata, String password) {
        return send_redpack(key, wxRedPack, (Object) keydata, password);
    }

    @Override
    public Map send_redpackgroup(String key, WxPayRedPackGroup wxRedPackGroup, File keydata, String password) {
        return send_redpackgroup(key, wxRedPackGroup, (Object) keydata, password);
    }

    @Override
    public Map send_coupon(String key, WxPayCoupon wxPayCoupon, File keydata, String password) {
        return send_coupon(key, wxPayCoupon, (Object) keydata, password);
    }

    @Override
    public Map pay_refund(String key, WxPayRefund wxPayRefund, File keydata, String password) {
