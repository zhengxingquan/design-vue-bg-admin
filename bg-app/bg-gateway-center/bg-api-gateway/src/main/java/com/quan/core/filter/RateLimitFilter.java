...
import com.quan.core.service.RateLimitService;
import com.quan.core.utils.TokenUtil;
...
public class RateLimitFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        //超额自增处理
        rateLimitServiceMap.forEach((k, v) -> {
            if (!v.checkRateLimit(reqUrl, accessToken)) {
                isOpenRateLimit.incrementAndGet();
            }
        });
