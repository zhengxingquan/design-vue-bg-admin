 ...
 * 描述：发送消息实体类
 */
public class WxInMsg extends LinkedHashMap<String, Object> implements Serializable {
    ...
    // TODO 重写数据
    private long getLong(String createTime, int i) {
        return  0;
    }
    ...
    // TODO
    private double getDouble(String location_x, int i) {
        return 0L;
    }
...
//    }
    ...
    private int getInt(String totalCount, int i) {
        return 0;
    }
