...
import com.quan.core.dao.FileExtendDao;
import com.quan.core.enume.FileType;
import com.quan.core.model.FileExtend;
...
public class FastDfsOssServiceImpl extends AbstractFileService {
    ...
    protected FileInfo mergeFile(String guid, String fileName, String filePath) throws Exception {
        ...
        try {
            ...
            fileExtends.stream().forEach(vo -> vo.setFileId(fileInfo.getMd5id()));
