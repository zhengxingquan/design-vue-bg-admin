...
import com.quan.BgPlatformCoreApplication;
...
@SpringBootTest(classes = {BgPlatformCoreApplication.class}, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
// 配置启动类
