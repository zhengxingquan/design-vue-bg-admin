...
import com.quan.core.cache.annotation.CacheResult;
...
public class CacheResultAop extends BaseCacheAop {
    ...
    public Object exec(ProceedingJoinPoint joinPoint, CacheResult ds) throws Throwable {
        log.info("CacheResult exec ....");
        ...
        if (!redisTemplate.hasKey(key)) {
            ...
            try {
                obj = CacheUtils.get(redisTemplate, key, method.getReturnType());
            } catch (Exception e) {
                //对象转换失败则清除缓存
