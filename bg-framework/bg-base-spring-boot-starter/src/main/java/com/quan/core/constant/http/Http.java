...
import com.quan.core.constant.http.send.FilePostSender;
...
public class Http {
    ...
    public static String post(String url, Map<String, Object> params, int timeout, int connTimeout) {
        return Sender.create(Request.create(url, Request.METHOD.POST, params, null)).setTimeout(timeout).setConnTimeout(connTimeout).send().getContent();
    }
    ...
    public static Response post3(String url, Object body, Header header, int timeout, int connTimeout) {
        return httpReq(url, Request.METHOD.POST, body, header, timeout, Sender.Default_Conn_Timeout);
    }
    ...
    public static Response upload(String url,
        ...
        Request req = Request.create(url, Request.METHOD.POST, params, header);
