...
import com.quan.common.exception.ComboException;
import com.quan.common.exception.OtherException;
import com.quan.common.exception.other.ContinueLoop;
import com.quan.common.exception.other.ExitLoop;
import com.quan.common.stream.Streams;
import com.quan.common.stream.StringInputStream;
import com.quan.common.stream.StringOutputStream;
...
public class Langs {
     ...
     * @return 文本输出流对象
     */
    public static com.quan.common.stream.StringWriter opw(StringBuilder sb) {
        return new com.quan.common.stream.StringWriter(sb);
    }
